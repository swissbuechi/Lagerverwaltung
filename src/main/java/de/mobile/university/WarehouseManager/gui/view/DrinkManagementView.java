...
import de.mobile.university.WarehouseManager.service.DrinkService;
...
public class DrinkManagementView extends GridPane {
    ...
    private ObservableList<Drink> drinkObservableList;
    ...
    public DrinkManagementView() {
        ...
        Set<Drink> drinks = drinkService.load();

        createUserTable();

        if (!drinks.isEmpty()) {
            drinkObservableList.addAll(drinks);
        }
//        createAndPlaceChangeForm();
    ...
    private void createUserTable() {
        ...
        drinkObservableList = FXCollections.observableArrayList();
        ...
        tableView.setItems(drinkObservableList);
